...
public record AssetRequest(
        ...
        @NotBlank(message = "Company name is required") @JsonProperty("company_name") String companyName,
        @NotBlank(message = "Sector is required") String sector,
        @NotNull(message = "Current value is required") @DecimalMin(value = "0.01", message = "Current value must be greater than zero")
